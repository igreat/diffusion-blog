...
function App() {
    return <div>
            ...
            <div class="container mx-auto flex flex-wrap items-center">
                ...
                <div class="flex w-full pt-2 content-center justify-between md:w-1/2 md:justify-end">
                    <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                        <li class="mr-3">
                            <A class="inline-block py-2 px-4 text-white no-underline" href="/intro">Introduction</A>
                        </li>
                        <li class="mr-3">
                            <A class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:text-underline py-2 px-4" href="/probability">Probability Theory</A>
                        </li>
                        <li class="mr-3">
                            <A class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:text-underline py-2 px-4" href="/diffusion">The Math of Diffusion</A>
                        </li>
                        <li class="mr-3">
        ...
        <Routes>
            ...
            <Route path="/diffusion" component={Diffusion} />
        </Routes>
    </div >
}
